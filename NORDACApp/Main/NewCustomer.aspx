<%@ Page Title="" Language="C#" MasterPageFile="~/Home.Master" AutoEventWireup="true" CodeBehind="NewCustomer.aspx.cs" Inherits="NORDACApp.Main.NewCustomer" %>
    ...
    <div class="box box-default">
            ...
            <div class="box-body">
              ...
              <asp:UpdatePanel runat="server" >
                ...
                <Tabs>
                    <telerik:RadTab runat="server" Text="Products" Enabled="false" >
                    </telerik:RadTab>
                    <telerik:RadTab runat="server" Text="Payments" Enabled="false">
                    </telerik:RadTab>
                </Tabs>
            </telerik:RadTabStrip>
